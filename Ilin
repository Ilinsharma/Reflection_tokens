...
contract TRUSTCake is BEP20, Ownable {
    ...
    GiantCakeDividendTracker public dividendTracker;
    ...
    constructor() public ERC20("TRUSTCAKE", "TRAKE") {
        ...
        excludeFromFees(_charityWalletAddress, true); // charity wallet 
        ...
        */
        _mint(owner(), 100000000000 * (10**18)); // 100,000,000,000  '100' Billion 
    }
    ...
    receive() external payable {
  	...
  	// For Removing stucked bnb in contract only by Owner
    ...
    function _transfer(
        ...
        if( canSwap &&
            ...
            uint256 marketingAndCharityTokens = contractTokenBalance.mul((marketingFee+charityWalletFee)).div(totalFees);
            swapAndSendToMarketingAndCharityFee(marketingAndCharityTokens);
    ...
    function swapAndSendToMarketingAndCharityFee(uint256 tokens) private  {
        ...
        IERC20(DividendToken).transfer(_charityWalletAddress, charityBalance); // towards charitywallet
...
contract TrustCakeDividendTracker is Ownable, DividendPayingToken {
    ...
    function _transfer(address, address, uint256) internal override {
        require(false, "GiantCake_Dividend_Tracker: No transfers allowed");
    }
